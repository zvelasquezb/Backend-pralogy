...
export class User_controller {
    ...
    static async create_user(req, res) {
        ...
        const teleplone = req.body.teleplone??"";
        const password = req.body.password;
        const current_state="Active";
        ...
        if(exists.length>0){
            ...
            const respose = await User_model.create_user(username, email, teleplone, hashed_password, current_state);
